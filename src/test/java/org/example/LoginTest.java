...
public class LoginTest extends BaseClass {
    ...
    @Test
            public void verifyLoggedInUser(String UserName, String Password) throws IOException {
                LoginPage loginPage = new LoginPage(BaseClass.getDriver());
                loginPage.login(UserName, Password);
                ...
                // Assert.assertTrue(driver.getCurrentUrl().contains("dashboard"), "Expected URL not found");
